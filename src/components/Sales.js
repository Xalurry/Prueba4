...
class Sales extends React.Component{
    ...
    addToCart = () =>{
        ...
        let discount = document.getElementById("discount").value;
        let isPercentage = discount.indexOf("%") > -1;
        errors += product.name === ""?"Seleciones un producto\n":"";
        errors += qty === "" ?"Se necesita la cantidad\n":"";
        errors += isPercentage && parseInt(discount.replace("%","")) > product.MDPercentge ? "No puede descontar mas del "+product.MDPercentge+"%\n": "";
                            ...
                            <div className="row">
                                ...
                                <div className="col-4">
                                    <div className="form-group">
                                        ...
                                        <input className="form-control" type="number" name="total" id="total" value={this.state.product.total} />
                                    </div>
                                </div>
                                <div className="col-12">
                                        ...
                                        <tbody>
                                            {this.state.cart.map(cl =>(
                                                <tr>
                                                    ...
                                                    <td>{cl.qty}</td>
                                                    <td>{cl.total}</td>
                                                    <td><button className="btn btn-danger"><i className="fas fas-trash"></i></button></td>
                                                </tr>
                                            ))}
                                        </tbody>
                                    </table>
